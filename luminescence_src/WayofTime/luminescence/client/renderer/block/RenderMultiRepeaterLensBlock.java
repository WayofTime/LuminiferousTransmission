...
public class RenderMultiRepeaterLensBlock extends TileEntitySpecialRenderer
{
	private ModelRepeaterLensBlock modelInputMirror = new ModelRepeaterLensBlock();
	private static final ResourceLocation field_110629_a = new ResourceLocation("textures/entity/beacon_beam.png");
	private static final ResourceLocation test = new ResourceLocation("luminescence:textures/models/RepeaterLens.png");

	@Override
	public void renderTileEntityAt(TileEntity tileEntity, double d0, double d1, double d2, float f)
	{
		if (tileEntity instanceof TEMultiRepeater)
		{
			TEMultiRepeater tileSpellBlock = (TEMultiRepeater) tileEntity;
