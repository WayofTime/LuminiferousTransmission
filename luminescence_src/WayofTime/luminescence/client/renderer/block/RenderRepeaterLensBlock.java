...
public class RenderRepeaterLensBlock extends TileEntitySpecialRenderer
{
	...
	{
		if (tileEntity instanceof TESingleRepeater)
		{
			TESingleRepeater tileSpellBlock = (TESingleRepeater) tileEntity;
			...
			boolean bool = tileSpellBlock.getBeamRenderTime()>0;
			if(bool)
			{
